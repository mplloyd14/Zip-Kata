...
ZipCollection.addData = function(newData) {
    console.log('Adding new data');
    return ZipCollection.save({city: newData.city, pop: newData.pop, state: newData.state, loc: newData.loc})
};
